...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// btnAgregarT
			// 
			this->btnAgregarT->Location = System::Drawing::Point(81, 122);
			this->btnAgregarT->Name = L"btnAgregarT";
			this->btnAgregarT->Size = System::Drawing::Size(121, 22);
			this->btnAgregarT->TabIndex = 19;
			this->btnAgregarT->Text = L"Agregar Recordatorio";
			this->btnAgregarT->UseVisualStyleBackColor = true;
			this->btnAgregarT->Click += gcnew System::EventHandler(this, &MyForm3::btnAgregarT_Click);
			// 
			// mTBPrioridad
			// 
			this->mTBPrioridad->Location = System::Drawing::Point(147, 55);
			this->mTBPrioridad->Mask = L"9";
			this->mTBPrioridad->Name = L"mTBPrioridad";
			this->mTBPrioridad->Size = System::Drawing::Size(14, 20);
			this->mTBPrioridad->TabIndex = 21;
			this->mTBPrioridad->ValidatingType = System::Int32::typeid;
			// 
			// label6
			// 
			this->label6->AutoSize = true;
			this->label6->Location = System::Drawing::Point(69, 58);
			...
			// TBDescripcion
			// 
			this->TBDescripcion->Location = System::Drawing::Point(147, 81);
			...
			this->label7->Location = System::Drawing::Point(54, 84);
			...
			this->Name = L"MyForm3";
			this->Text = L"Agregar Recordatorio";
...
#pragma endregion
	...
	public: MyForm3(String^ route, String^ year, String^ month, String^ day) {
		InitializeComponent();
		ruta = route;
		mes = month;
		año = year;
